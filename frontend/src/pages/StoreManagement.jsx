...
import StoreOrders from "../components/StoreOrders"; // Import component Orders (đơn hàng cửa hàng)
...
const StoreManagement = () => {
  ...
  const [activeTab, setActiveTab] = useState("info"); // "info", "products", "orders"
      ...
      <div className="max-padd-container">
        ...
        <div className="flex gap-6 mb-4 border-b border-gray-200">
          ...
          <button
            ...
            className={`px-4 py-2 ${activeTab === "orders" ? "border-b-2 border-secondary text-secondary" : ""}`}
          >
            Orders
          </button>
        </div>
